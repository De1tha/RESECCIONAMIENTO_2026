...
var style_ST2_MANZANA_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("manzana") !== null) {
        ...
        function rules_ST2_MANZANA_6(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ST2_MANZANA_6rule0_eval_expression(context)) {
        ...
        var style = rules_ST2_MANZANA_6(feature, value);
        ;
