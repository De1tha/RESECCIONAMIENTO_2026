...
var style_ST3_MANZANA_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("manzana") !== null) {
        ...
        function rules_ST3_MANZANA_5(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ST3_MANZANA_5rule0_eval_expression(context)) {
        ...
        var style = rules_ST3_MANZANA_5(feature, value);
        ;
